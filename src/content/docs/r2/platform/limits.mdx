...
Enable [edge caching of your R2 content](https://developers.cloudflare.com/cache/interaction-cloudflare-products/r2/) by configuration Cache Everything or set more narrow cache rules. Further enhance cache levels by enabling [Tiered Cache](/cache/how-to/tiered-cache/).
